//  Boost Unions Library, basic tagged_union example program file  -----------//
...
#include "boost/unions/tagged_union.hpp"  // for boost::unions::tagged_union
...
typedef boost::unions::tagged_union<int, double>  intdouble_t;
...
// Generators
intdouble_t  make_int()     { return { -2 }; }
intdouble_t  make_double()  { return { +3.75 }; }
...
int  main()
{
    ...
    boost::unions::tagged_union<>  test3{};
